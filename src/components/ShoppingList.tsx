...
export function ShoppingList() {
    const [items, setItems] = useState<{ nome: string; quantidade: number}[]>([]); //Armazeno os itens da lista
    ...
    return (
        <div> 
            {error && <Alert severity="error">{error}</Alert>} {/*Se houver erro, exibe a mensagem de erro*/}
            {sucess && <Alert severity="success">{sucess}</Alert>} {/*Se houver erro, exibe a mensagem de erro*/}
            <input 
            type="text"
            value={newItem} 
